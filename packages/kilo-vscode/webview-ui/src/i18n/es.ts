export const dict = {
  ...
  "marketplace.status.actionTimeout": "La acción de Marketplace ({{action}}) excedió el tiempo de espera. Inténtalo de nuevo.",
  "marketplace.status.requestTimeout": "La solicitud de Marketplace excedió el tiempo de espera. Inténtalo de nuevo.",
  "marketplace.status.projectInstallRequiresWorkspace":
    "Abre una carpeta de espacio de trabajo para instalar elementos de Marketplace con alcance de proyecto.",
  "marketplace.status.projectInstallRequiresWorkspaceTooltip":
    "Abre una carpeta de espacio de trabajo para instalar en el alcance del proyecto.",
  "marketplace.status.noWorkspaceBanner":
    "Abre una carpeta de espacio de trabajo para habilitar instalaciones de proyecto. Las instalaciones globales siguen disponibles.",
  ...
  "provider.connect.apiKey.description": "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Kilo.",
  "provider.connect.opencodeZen.line1": "OpenCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.opencodeZen.line2": "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.oauth.code.visit.suffix": " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Kilo.",
  "provider.connect.oauth.auto.visit.suffix": " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Kilo.",
