export const dict = {
  ...
  "marketplace.status.actionTimeout": "Marketplace {{action}} timed out. Please try again.",
  "marketplace.status.requestTimeout": "Marketplace request timed out. Please try again.",
  "marketplace.status.missingRequired": "Missing required fields: {{fields}}",
  "marketplace.status.projectInstallRequiresWorkspace": "Open a workspace folder to install project-scoped marketplace items.",
  "marketplace.status.projectInstallRequiresWorkspaceTooltip": "Open a workspace folder to install to project scope.",
  "marketplace.status.noWorkspaceBanner": "Open a workspace folder to enable project installs. Global installs remain available.",
