export const dict = {
  ...
  "prompt.rebuildPopover.title": "Rebuild code index",
  "prompt.rebuildPopover.description": "Rebuild the local index used for code search and retrieval.",
  "prompt.rebuildPopover.confirm": "Rebuild now",
